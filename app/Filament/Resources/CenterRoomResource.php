...
use App\Filament\Resources\CenterRoomResource\Pages;
...
class CenterRoomResource extends Resource
{
    protected static ?string $model = CenterRoom::class;

    protected static ?string $modelLabel = 'اتاق مرکز';

    protected static ?string $pluralModelLabel = 'اتاق‌ها';

    protected static ?string $navigationLabel = 'اتاق‌ها';
    ...
    {
        return [
            'index' => Pages\ListCenterRooms::route('/'),
            'create' => Pages\CreateCenterRoom::route('/create'),
            'edit' => Pages\EditCenterRoom::route('/{record}/edit'),
        ];
    }
