...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('suicide_statistics', function (Blueprint $table) {
            ...
            $table->enum('marital_status', ['motahel', 'mojarad', 'motalaghe', 'biave'])->nullable();
            $table->string('education_level', 50)->nullable();
            $table->string('occupation', 100)->nullable();
            $table->enum('employment_status', ['shaghel', 'bikar', 'bazneshasteh', 'daneshjoo'])->nullable();
            ...
            $table->enum('urban_rural', ['shahri', 'roostaei']);
            $table->date('event_date');
            $table->time('event_time')->nullable();
            $table->string('event_location', 200)->nullable();
            $table->enum('method', ['halaq_aviz', 'khodsoozi', 'porsh', 'gharagh', 'daro', 'khoon_rizi', 'sayer']);
            ...
            $table->enum('suicidal_intent', ['payeen', 'motevaset', 'bala'])->nullable();
