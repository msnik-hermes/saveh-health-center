...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (!Schema::hasTable('manager_access_levels')) {
        ...
        if (!Schema::hasTable('access_reports')) {
        ...
        // جدول تغییرات دسترسی
        if (!Schema::hasTable('access_changes')) {
