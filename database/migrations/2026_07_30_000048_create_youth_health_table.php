...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('youth_health', function (Blueprint $table) {
            ...
            $table->string('age_group')->default('10_14');
            ...
            $table->string('mental_health_screening')->default('tabii')->nullable();
            $table->string('substance_abuse_screening')->default('tabii')->nullable();
